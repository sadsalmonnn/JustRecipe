...
export declare class McpServer {
    ...
    }, cb: ToolCallback<InputArgs, OutputArgs>): RegisteredTool;
    /**
 ...
 */
type TypedCallToolResult<OutputArgs extends undefined | ZodRawShape> = OutputArgs extends ZodRawShape ? CallToolResult & {
 ...
 */
export type ToolCallback<InputArgs extends undefined | ZodRawShape = undefined, OutputArgs extends undefined | ZodRawShape = undefined> = InputArgs extends ZodRawShape ? (args: z.objectOutputType<InputArgs, ZodTypeAny>, extra: RequestHandlerExtra<ServerRequest, ServerNotification>) => TypedCallToolResult<OutputArgs> | Promise<TypedCallToolResult<OutputArgs>> : (extra: RequestHandlerExtra<ServerRequest, ServerNotification>) => TypedCallToolResult<OutputArgs> | Promise<TypedCallToolResult<OutputArgs>>;
